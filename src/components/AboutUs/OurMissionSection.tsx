    ...
    <OurMissionSectionContainer>
      <TextContent>
        ...
        <Content>
          ...
          디자인 원칙을 결합하여 전 세계적으로 그 가치를 알리고 있습니다. 우리의
          미션은 한국 도자기의 예술성과 장인정신, 그리고 문화적 의미를 세계에
          소개하는 글로벌 플랫폼을 구축하는 것입니다. 도자기 전시회, 뉴스,
          브랜드 정보를 제공하는 공간을 통해 현대적이고 전통적인 한국 도자기를
          사랑하는 이들을 연결하고, 그들의 지식과 영감을 확장하는 것이 ‘홋'의
          목표입니다.
        </Content>
      </TextContent>
      <ImageContent>
